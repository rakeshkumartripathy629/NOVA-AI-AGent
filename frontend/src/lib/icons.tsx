...
export function PinIcon({ size = 15 }: IconProps) {
  return (
    ...
    >
      <path d="M12 17v5" />
      <path d="M9 10.8V6a3 3 0 0 1 6 0v4.8l2 3.2H7z" />
      <circle cx="12" cy="10" r="1.5" fill="currentColor" />
    </svg>
  );
}

export function SpeakerIcon({ size = 15 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ThumbsUpIcon({ size = 14 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path d="M7 10v12" />
      <path d="M15 5.9L14 10h5.4a1.9 1.9 0 0 1 1.8 2.5l-1.6 6A2 2 0 0 1 17.7 20H7V10l4-7a2.4 2.4 0 0 1 4 2.9z" />
    </svg>
  );
}

export function ThumbsDownIcon({ size = 14 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path d="M17 14V2" />
      <path d="M9 18.1L10 14H4.6a1.9 1.9 0 0 1-1.8-2.5l1.6-6A2 2 0 0 1 6.3 4H17v10l-4 7a2.4 2.4 0 0 1-4-2.9z" />
    </svg>
  );
}
...
export function ShieldIcon({ size = 17 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
