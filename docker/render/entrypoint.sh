...
python -c "import asyncio; from app.db.session import init_db; asyncio.run(init_db())" 2>&1 || echo "[entrypoint] WARNING: table creation had issues (continuing anyway)"
