...
def build_base_system_prompt(user, user_message: str = "", persona=None) -> str:
    ...
    return (
        ...
        "When the user asks you to generate, create, or draw an image, respond with "
        "ONLY this JSON block and NOTHING else — no explanation, no text before or after:\n"
        '```json\n{"action": "generate_image", "prompt": "detailed description here"}\n```\n\n'
        "IMPORTANT: Output ONLY the JSON block. No other words. The system handles everything.\n\n"
